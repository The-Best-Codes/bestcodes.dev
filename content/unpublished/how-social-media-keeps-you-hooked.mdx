...
Once again, I am splitting this section into two parts. First, how to disrupt the Hooked Model, and second, how to deal with FoMO. Both are highly applicable to social media usage, but they can be applied to other areas of life too!

### Disrupting the Hooked Model

Since we know that the Hooked Model has four phases, stopping it effectively requires a plan to address each phase.

#### Phase 1: Trigger

As we already discussed, social media relies on many triggers, both internal and external. First, we'll focus on external triggers, because they are easier to control. Here are some common external triggers:

- **Notifications** are a very prevalent trigger used in apps in general (not just social media). Most apps allow you to disable notifications altogether, or you can disable notifications except important ones (like important messages from friends and family).
- **Streaks** are records of consecutive timespans spent performing actions at certain intervals. For example, if someone has a 100-day Snapchat streak, it means that they have sent a message every day for 100 days. Streaks are investments that are easy to lose and can be lost in a predictable way. If you don't send your daily message on Snapchat one day, you'll lose your streak! And since you've invested so much time and effort into maintaining that streak, it feels like a valuable investment. Once you understand this, **streaks are easy to break**. How important is it really? Just because you spent 100 days creating a streak doesn't mean it's worth 100 days of your life. It's just a number. One day, purposely lose your streak; then you won't be motivated by it anymore.
- Many apps also use **badges** to make it obvious when you have an unread message or notification. But social media will commonly give you notifications that aren't actually important or don't need immediate attention, like "Someone liked your post". The goal of **badges** is to trigger you to open the app. Just like you can turn off notifications, most apps allow you to turn off badges too.
...
Small things such as those will help you limit usage more than you might think!

#### Phase 3: Variable Rewards

Variable rewards are hard to resist. It's not like there's a button in apps that says "Turn off variable rewards". Since we can't turn them off, we can instead reclaim rewards elsewhere. Social media gives you rewards like novelty, connection, and entertainment. You can get those in other ways: through hobbies, meeting people face-to-face, or reading books.

#### Phase 4: Investment

The only way to stop investing so much into social media apps is to... stop investing so much into social media apps. You can't invest less of your time unless you actually spend less time on them. You can't invest less of your data unless you stop letting apps collect it. You can't invest less of your attention unless you stop giving it to them.
You can do all that with the things we discussed above. You might have noticed something that was repeated in the prevention of each phase: alternatives. Alternatives are powerful. When you're addicted to something, it usually takes up a lot of your time and attention, so it's hard to be addicted to multiple things at once. If you've got more options that are just as appealing as social media, you can divide your time between them.
