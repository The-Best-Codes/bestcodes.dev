...
author:
  name: BestCodes
image:
  url: /image/blog/how-social-media-keeps-you-hooked-cover.png
...
> **TODO[STUB]: THIS ARTICLE IS INCOMPLETE.**
> Now that the thoughts and research are here, this article needs completely rewritten to flow smoothly and coherently without being redundant or repetitive.
> Consider committing updates to a separate branch so that you can work on other parts of your website in the meantime.
...
This article will explain an important contributing factor to social media addiction: the Hooked Model. It will also explore a general concept that the Hooked Model relies on, FoMO.

First, I will define the Hooked Model and FoMO so you know what they are, which will help you understand the rest of this article. Next, I'll give some examples and go more in depth about how the Hooked Model works. At the end, I've included some practical tips to help you break the Hooked cycle.
...
I'll go into more detail about each stage and give some examples in a bit, but let's cover FoMO first.

## What is FoMO?

FoMO means "Fear of Missing Out". It's often abbreviated in all caps, like "FOMO".
FoMO isn't specific to social media, electronic devices, or even technology in general. A better way to describe what we call FoMO might be "Anxiety of Missing Out".[^1]
...
Remember the four stages of the Hooked Model? A **trigger** to begin using the product, an **action** to satisfy the trigger, a **variable reward** for the action, and some type of **investment** that, ultimately, makes the product more valuable to the user. As the user goes through these phases, he builds habits in the process.[^3]
...
At this point in our imaginings, John has a choice. He's seen several boring posts and ads, so he could be tired of the app and close it or he could scroll again in hopes of finding something else interesting. If John has used Instagram before, he knows that he will eventually find something interesting (this is one factor of the variable reward).
He decides to scroll down more. Wait... a funny cat video! John loves cat videos. He watches it. Lastly, he sees a video from a legal "professional" about a new law that will affect him in some way.
...
First, the **trigger** was John's boredom and perceived lack of things to do. I say _perceived_ because John didn't actually have nothing to do, but he felt that way for a moment. Social media platforms take advantage of this moment by being first-to-mind.[^4] When you think "I'm bored", Instagram is the first thing that comes to mind to do, so before you think of alternatives, you impulsively open it up.
...
Interestingly, variable rewards have also been shown to be more motivating than fixed rewards for certain animals, such as pigeons.[^5]
...
Thus, the cycle continues, and the more the cycle repeats, the more likely it is to become a habit.[^6]
...
| ------------------- | ----------------------------------------------------------------------------------------------------- |
| **Trigger**         | Notifications, badges, “streaks,” boredom, loneliness, curiosity, social comparison; eventually habit |
...
**In the Variable Reward:** FoMO is not quite _directly_ related to the variable reward, but it amplifies its effect. For example, the relief when you see you haven't missed anything, or the comfort that you opened the app just in time to see an important announcement post from 5 minutes ago.

In short, FoMO is a trigger and a reward amplifier.

---

## What You Can Do

To "unhook" yourself from social media, we need to block or reduce the effects of the parts of the Hooked Model that we can. It's hard to disrupt variable rewards and investments without just cutting out social media cold-turkey (which is an option, of course!), so we'll focus on disrupting the trigger and action.

#### Disrupting the Trigger: Remove It!

The most effective way to disrupt a trigger is to remove it entirely! As we already discussed, social media relies on many triggers, both internal and external. First, we'll focus on external triggers, because they are easier to control. Here are some common external triggers:

- **Notifications** are a very prevalent trigger used in apps in general (not just social media). Most apps allow you to disable notifications altogether, or you can disable notifications except important ones (like important messages from friends and family). Try opening your social media apps, going to settings, and looking for "Notifications" to adjust them.
- **Streaks** are records of consecutive timespans spent performing actions at certain intervals. For example, if someone has a 100-day Snapchat streak, it means that they have sent a message every day for 100 days. Streaks are investments that are easy to lose and can be lost in a predictable way. If you don't send your daily message on Snapchat one day, you'll lose your streak! And since you've invested so much time and effort into maintaining that streak, it feels like a valuable investment. Once you understand the psychology behind a streak, you realize that it's not really that important, and the **streak becomes easy to break**! Think: How important is the streak? Just because you spent 100 days creating a streak doesn't mean it's worth 100 days of your life. It's just a number. To disrupt a streak, purposely lose it; then you won't be motivated by it anymore.

As far as internal triggers, besides FoMO, the primary internal trigger is habit. Habits are automatic behaviors that are triggered by certain cues. Social media's goal is to be first-to-mind when you think "I'm bored". So you should think of other options you can immediately consider when you're bored. For example, go for a walk, read a book, etc. Remember these options next time you feel bored and choose one of them instead of social media.

#### Disrupting the Action: Add Friction

As we discussed, the actions social media platforms want you to take are things like opening the app, scrolling through your feed, viewing ads, investing time, and so on. These actions are designed to be as easy and effortless as possible (just one tap away!).
So what can you do? Add friction. Make it harder to perform these actions. Move apps off of your home screen and into a folder, making it take more work to open. Use a [social media blocker](https://www.google.com/search?q=social+media+blockers) to only allow using the app at certain times of the day.
You'd be _very_ surprised how effective adding friction can be. Simply removing social media icons from your home screen or anywhere else you might see them is very powerful.

---

## Footnotes

[^1]: Przybylski, Andrew K., Kou Murayama, Cody R. DeHaan, and Valerie Gladwell. “Motivational, emotional, and behavioral correlates of fear of missing out.” _Computers in Human Behavior_ 29, no. 4 (July 2013): 1841–1848. https://doi.org/10.1016/j.chb.2013.02.014.
...
[^3]: Nir Eyal, "The Hooked Model: How to Manufacture Desire in 4 Steps," [What is the Hooked Model? section](https://www.nirandfar.com/how-to-manufacture-desire/#:~:text=The%20Hooked%20Model%20is%20a,builds%20habits%20in%20the%20process.)

[^4]: LinkedIn Marketing Solutions, "First to Mind", https://business.linkedin.com/marketing-solutions/content-marketing/b2b-trends/first-to-mind; Nir Eyal, "The Hooked Model: How to Manufacture Desire in 4 Steps," [First to Mind Wins section](https://www.nirandfar.com/how-to-manufacture-desire/#:~:text=in%20the%20process.-,First%2Dto%2DMind%20Wins,-A%20company%20that)

[^5]: Ferster, C. B., & Skinner, B. F. (1957). _Schedules of Reinforcement_. B. F. Skinner Foundation. Retrieved from https://www.bfskinner.org/wp-content/uploads/2015/05/Schedules_of_Reinforcement_PDF.pdf

[^6]: Lally, Phillippa, Cornelia H. M. van Jaarsveld, Henry W. W. Potts, and Jane Wardle. “How are habits formed: Modelling habit formation in the real world.” _European Journal of Social Psychology_ 40, no. 6 (October 2010): 998–1009. https://doi.org/10.1002/ejsp.674.
