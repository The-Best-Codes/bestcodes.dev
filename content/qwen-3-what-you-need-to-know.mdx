---
title: "Qwen 3 Benchmarks, Comparisons, Model Specifications, and More"
...
image:
  ...
  alt: "Qwen3 announcement banner featuring the Qwen mascot and large text reading 'Qwen 3'"
  fit: contain
tags:
  - benchmarks
  - ai
...
![A comparison chart showing performance scores of various language models on different benchmarks, including Qwen3-235B-A22B, Qwen3-32B, OpenAl-o1, Deepseek-R1, Grok 3 Beta, Gemini2.5-Pro, and OpenAl-o3-mini, across benchmarks like ArenaHard, AIME'24, AIME'25, LiveCodeBench, CodeForces, Aider, LiveBench, BFCL, and MultiIF.](/image/blog/qwen3-benchmarks/with-reasoning-1.webp)
...
![Table comparing performance metrics of different language models including Qwen3-30B-A3B, QwQ-32B, Qwen3-4B, Qwen2.5-72B-Instruct, Gemma3-27B-IT, DeepSeek-V3, and GPT-4o on various benchmarks such as ArenaHard, AIME'24, AIME'25, LiveCodeBench, CodeForces Elo Rating, GPQA, LiveBench, BFCL, and MultiIF.](/image/blog/qwen3-benchmarks/with-reasoning-2.webp)
...
![Table comparing the performance of several language models on various tasks, including general, math & science, multilingual, and code tasks. Models include Qwen2.5-72B Base, Qwen2.5-Plus Base, LLaMA-4-Maverick Base, DeepSeek-V3 Base, and Qwen3-235B-A22B Base. Performance metrics are provided for each task.](/image/blog/qwen3-benchmarks/with-reasoning-3.webp)
