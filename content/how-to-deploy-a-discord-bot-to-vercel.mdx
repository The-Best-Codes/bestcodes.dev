...
image:
  ...
  alt: "Banner promoting the deployment of Discord bots to Vercel. Features the text 'Deploy Discord Bots to Vercel', above the Discord logo, the Vercel logo, and the Google generative AI logo."
  fit: contain
tags:
  - tutorial
  - vercel
...
![Discord Create an Application dialog with the name "Gloriously Happy Egg" entered.](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/nbvjpspj9xkjd2kgvyn7.png)
...
![Configuration screen for a bot named "Gloriously Happy Egg", featuring a happy egg cartoon icon, a description field, and tags "egg," "happy," "chicken," and "glorious".](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/2x9eq723z25zfv6i6r2h.png)
...
![Discord application installation settings: including user install checkbox (unchecked), guild install checkbox (checked), and a generated installation link.](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/tmo4osyx8pwy2vdb2x6z.png)

Paste the invite link in your browser and add the bot to your server of choice. Yay!

![Screenshot of a Discord message: "Yay you made it, Gloriously Happy Egg! Today at 2:48 PM" with a green arrow pointing to the right.](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/r84tazetsv8kmk93th0j.png)
...
![Screenshot of command line output showing the initialization of a new project using Vercel, TypeScript, and Google AI, using npm as the package manager. The project is being initialized in the `/workspaces/codespaces-blank/my-vercel-bot` directory. Template files have been copied and dependencies are being installed.](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/v4boos1odxthd11ngf70.png)
...
![Screenshot of an API key generation confirmation, including an API key obscured by a grey block and a blue "Copy" button. The text "API key generated" and "Use your API keys securely. Do not share them or embed them" is visible.](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/34lviqptsi3mpfp4nocf.png)

Alright, by now, your `.env` file should have **no empty values**. It should look like the one in this picture, with your secrets:

![Code snippet of a .env file for a Discord bot and Google AI integration, showing environment variables like DISCORD_PUBLIC_KEY, DISCORD_APP_ID, DISCORD_TOKEN, GOOGLE_AI_API_KEY, and GOOGLE_AI_MODEL, along with related documentation URLs. Sensitive keys are pixelated.](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/53k0ccdzx6j9cxhjazp6.png)
...
![Screenshot of a project directory structure in a code editor, named "my-vercel-bot," with subdirectories including "commands," "public," "scripts," and "utils," along with various TypeScript files, JSON files, a README.md file, and environment-related files.](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/qxd1e3ud6jsl1n275dc8.png)
...
![Screenshot of a "Projects" dashboard showing a project card labeled "my-vercel-bot" with associated URL, "Connect Git Repository" prompt, and recent activity.](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/wlwn72gvcr18156mea2p.png)
...
![Screenshot of environment variables settings panel with key-value pairs for Discord and Google AI, including an "Add Another" button and a "Save" button.](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/k463lihxxtu9ksq5gtnm.png)
...
![Discraft Bot Deployment, with text: This is a deployment for a bot created with Discraft. The API route is: /api.](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/tzul6ghd4z3xqsnp3o15.png)
...
![Screenshot of Discord bot settings showing the interactions endpoint URL set to https://my-vercel-bot.vercel.app/api.](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/yzyqmqnuoxhe77wwty0s.png)
...
![Discord command list for '/ping', showing different bots and their functions, with one entry highlighted and an arrow pointing to the command input field.](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/1n48c2ud2blc6dnghra1.png)

Press `enter` to select the command. Press `enter` again to run it.

![Screenshot of a Discord bot command, "/ping", with the description "Check if the bot is online". Another line shows the same command next to a bot icon that features an egg character.](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/e1kurrggh8rdnxo5rpp5.png)
