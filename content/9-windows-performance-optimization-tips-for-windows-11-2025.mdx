...
description: "From enabling performance mode to managing startup programs and disabling unused services, these tips will help you optimize Windows 11 for max performance."
date:
  created: "2025-05-20"
  updated: "2025-05-20"
author:
...
![Screenshot of Windows Startup apps list showing various apps with their status and startup impact.](/image/blog/windows-11-performance-tips-2025/startup-apps-task-manager.png)

Right-click on the startup apps you want to disable at startup and select **Disable**.

![Screenshot showing "Expand" and "Disable" options in a menu.](/image/blog/windows-11-performance-tips-2025/startup-apps-right-click.png)
...
![Screenshot of installed applications on a Windows operating system.](/image/blog/windows-11-performance-tips-2025/apps-installed-sort-by-large.png)
...
![Screenshot of Windows Disk Cleanup tool displaying file options.](/image/blog/windows-11-performance-tips-2025/disk-cleanup.png)
...
- Go to **Hardware and Sound** from the Control Panel.
  ![Windows Control Panel: Hardware and Sound settings selection.](/image/blog/windows-11-performance-tips-2025/control-panel-hardware-sound.png)
- Click on **Power Options**.
- Scroll to the bottom and click on the "Show additional plans" accordion.
  ![Windows Power Options: Balanced and Power Saver plan choices.](/image/blog/windows-11-performance-tips-2025/control-panel-more-plans.png)
- Select **High Performance**.
  ![Screenshot of Windows power plan settings: high performance selected.](/image/blog/windows-11-performance-tips-2025/control-panel-high-perf.png)
...
![Windows Update showing that the system is up to date.](/image/blog/windows-11-performance-tips-2025/windows-update.png)
...
![Windows performance options: Visual Effects, "Adjust for best performance" selected.](/image/blog/windows-11-performance-tips-2025/best-performance-less-animations.png)
...
![Copilot app permissions: microphone off, background power optimized.](/image/blog/windows-11-performance-tips-2025/power-optimized-background.png)
...
![Windows Optimize Drives window showing drive status.](/image/blog/windows-11-performance-tips-2025/defrag.png)
...
![Screenshot of Windows "Game Mode" settings.](/image/blog/windows-11-performance-tips-2025/game-mode.png)
