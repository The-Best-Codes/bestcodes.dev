...
![Bar graph comparing the performance of different AI models across five benchmarks; y-axis is score.](/image/blog/phi4-reasoning-benchmarks/general-1.png)
...
![Bar graph illustrating performance of Phi-4-mini-reasoning and other language models on math benchmarks.](/image/blog/phi4-reasoning-benchmarks/mini-math.png)
...
![AI chat repeatedly says "We need to produce a greeting response."](/image/blog/phi4-reasoning-misc/hello-chat.png)
...
![Screenshot of a chatbot interface where a user asks which is larger, 9.11 or 9.9, and the chatbot answers correctly.](/image/blog/phi4-reasoning-misc/larger-9.png)

Sometimes, as with many reasoning models, the answer is okay, but the reasoning to get there is a bit weird:

![Screenshot of a conversation with the Phi 4 Reasoning AI model, showing the user asking "What time is it?".](/image/blog/phi4-reasoning-misc/weird-reasoning.png)
