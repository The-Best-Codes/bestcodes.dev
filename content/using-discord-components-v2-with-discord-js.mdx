...
It's quite simple to migrate to Components v2 with Discord.js. You can see the [list of available components on the Discord.js docs](https://discord.com/developers/docs/components/reference).
